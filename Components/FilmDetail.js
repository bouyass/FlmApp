...
class FilmDetail extends React.Component {
  ...
  componentDidUpdate(){
      console.log(this.props.favouritesFilm);
  }
  _displayFavouriteImage(){
     var sourceImage = require('../Images/ic_favorite_border.png')
     if (this.props.favouritesFilm.findIndex( item => item.id === this.state.film.id) !== -1 ){
        var sourceImage = require('../Images/ic_favorite.png')
     }
     return(
       <Image source={sourceImage} style={styles.favourite_image}/>
     )
  }
